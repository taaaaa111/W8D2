...
HTML / CSS
 ...
 Après avoir construit les élément de base du front de ton application, nous allons te demander de construire les éléments que l'on retrouvera sur ton futur site internet.
 Tu vas continuer l'apprentissage du design par composant tout en manipulant la mise en page d'éléments CSS
